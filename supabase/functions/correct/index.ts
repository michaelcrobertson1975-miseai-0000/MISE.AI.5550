...
function q(path){return fetch('/rest/v1/'+path,{headers:H}).then(function(r){
...
function save(id){
  ...
  fetch('/rest/v1/rpc/mise_apply_correction',{method:'POST',headers:H,
    body:JSON.stringify({p_line_item_id:id,p_patch:patch,p_ingredient_name:newName||null})})
  .then(function(r){
