/**
 * Vertex AI access tokens from a service account, signed in the Edge
 * runtime. Copied verbatim from ingest-invoice's own googleAuth.js so both
 * functions authenticate against Vertex identically.
 */
let cached = null;
